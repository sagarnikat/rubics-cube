...
const int UI_FONT_INPUT  = 20;
const int UI_FONT_MSG    = 20;

// Path to font file
const char *FONT_PATH = "resources/Inter-Black.otf";
...
int main() {
    ...
    Vector2 netOrigin = {40.0f, 120.0f};  // MOVED DOWN to avoid overlap with instructions
    ...
    while (!WindowShouldClose()) {
        ...
        Rectangle msgBox = { 
            (float)ox, 
            (float)(oy + 3*(faceH + faceSpacing) + 40),  // Moved further down
